...
public class HistogramToolAction extends javax.swing.AbstractAction 
{
	...
	final InteractiveRealViewer viewer;
	
	public HistogramToolAction(InteractiveRealViewer viewer)
	{
		this.viewer = viewer;
	}
