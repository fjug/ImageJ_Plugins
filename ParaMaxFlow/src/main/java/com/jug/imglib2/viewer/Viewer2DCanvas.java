...
public class Viewer2DCanvas extends JComponent implements MouseInputListener {
	...
	public void setDoubleTypeScreenImage( final IntervalView< DoubleType > viewImg ) {
		...
		this.projector = new Projector2D< DoubleType, ARGBType >( 0, 1, viewImg, screenImage, new RealARGBConverter< DoubleType >( min.get(), max.get() ) );
		this.view = viewImg;
		this.repaint();
	}
	...
	public void setLongTypeScreenImage( final IntervalView< LongType > viewImg ) {
		...
		ImglibUtil.computeMinMax( viewImg, min, max );
		this.projector = new Projector2D< LongType, ARGBType >( 0, 1, viewImg, screenImage, new RealARGBConverter< LongType >( min.get(), max.get() ) );
		this.view = viewImg;
		this.repaint();
	}
