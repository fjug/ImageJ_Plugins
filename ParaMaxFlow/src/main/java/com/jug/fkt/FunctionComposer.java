 ...
 * @author jug
 */
public class FunctionComposer implements ActionListener {

	private static FunctionComposer instance;
	...
	public FunctionComposer(final Function1D<Double> initFkt) {
		this();
