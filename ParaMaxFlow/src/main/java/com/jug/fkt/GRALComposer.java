...
import com.jug.paramaxflow.gui.GRALPanel;

/**
* @author jug
*/
public class GRALComposer implements ActionListener {

	private static GRALComposer instance;
	...
	private final GRALPanel plotPanel;

	public GRALComposer(final Function1D<Double> initFkt) {
		this();
		...
		if ( initFkt instanceof Sigmoid1D ) {
		...
		if ( initFkt instanceof Gaussian1D ) {
	...
	public GRALComposer() {
		...
		plotPanel = new GRALPanel();
		plotPanel.setFixedBounds(1, -1, 1);
		updatePlotPanel();
